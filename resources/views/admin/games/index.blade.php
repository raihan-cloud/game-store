                        ...
                        <tbody>
                            @forelse ($games as $game)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.games.edit', $game->id) }}" class="btn btn-info btn-xs">
                                            <i class="fas fa-pencil-alt"></i> Edit
                                        </a>
                                        
                                        <form action="{{ route('admin.games.destroy', $game->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">
                                        Belum ada data game. Silakan tambah game baru.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
